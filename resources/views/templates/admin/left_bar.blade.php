@php $auth=Auth::user(); @endphp
            <section class="sidebar">
                ...
                <div class="user-panel">
                    ...
                    <img src="{{$urlAdmin}}/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                    </div>
                    <div class="pull-left info">
                        <p>{{ $auth->username }}</p>
                        <a href="#">{{ $auth->fullname }}</a>
                    </div>
                </div>
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="pages/examples/pace.html"><i class="fa fa-circle-o"></i> Pace Page</a>
                            </li>
                        </ul>
                    </li>
                    <li class="treeview">
